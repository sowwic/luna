...
class JointFnTests(TestCase):
    ...
    def test_joint_chain(self):
        ...
        # Assertions
        expected_chain = ["c_spine_ik_00_jnt", "c_spine_ik_01_jnt",
                          "c_spine_ik_02_jnt", "c_spine_ik_03_jnt"]
    ...
    def test_duplicate_chain_replace_side(self):
        ...
        jointFn.duplicate_chain(new_joint_name=["spine", "ik"],
                                new_joint_side="l",
                                start_joint="c_spine_ik_00_jnt")
    ...
    def test_duplicate_chain_start_end(self):
        ...
        duplicated_chain = jointFn.duplicate_chain(
            new_joint_name=["arm", "fk"], new_joint_side="c", start_joint="c_spine_ik_01_jnt", end_joint="c_spine_ik_02_jnt")
